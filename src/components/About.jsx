...
const AboutFunc = () => {
  return (
    <>
      <SEO
        title="About Auragene Technologies | Web Development & AI Company"
        description="Learn about Auragene Technologies, a software company specializing in web development, SaaS platforms, AI automation, UI/UX design, ERP solutions, cloud applications, and scalable digital products."
      ...
      <div className="about-section">
        ...
        <div className="values-container">
          <div className="value-item">
            ...
            <p>
              We embrace cutting-edge technologies and stay ahead of industry
          ...
          <div className="value-item">
            ...
            <p>
              ...
              ensure excellence and reliability.
            </p>
          </div>
          ...
          <div className="value-item">
            ...
            <p>
              Your success is our success. We prioritize communication and
          ...
          <div className="value-item">
            ...
            <p>
              Our solutions grow with your business, built for scalability and
