...
const ProjectFunc = () => {
  ...
  const projectShowcase = [
    ...
    },
    {
      ...
      category: "web",
      description:
        "Enterprise solution for managing operations and analytics.",
    ...
    },
    {
      ...
      category: "mobile",
      description:
        "Cross-platform fitness tracking and workout management app.",
    ...
    },
    {
      ...
      category: "automation",
      description:
        "Smart workflow automation to eliminate repetitive tasks.",
    ...
    },
    {
      ...
      category: "ai",
      description:
        "Intelligent customer support chatbot with NLP.",
  ...
  return (
    <>
      <SEO
        title="Projects | Auragene Technologies"
        description="Explore Auragene Technologies' portfolio of web development, SaaS platforms, AI automation, mobile applications, business software, and custom digital solutions."
