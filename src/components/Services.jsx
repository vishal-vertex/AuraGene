  ...
  const servicesDetails = [
    {
      ...
      fullDesc: "Custom responsive websites, business portals and web solutions.",
      features: [
        "Responsive Design",
        "SEO Optimization",
        "Fast Performance",
    ...
    },
    {
      ...
      fullDesc: "Scalable desktop and enterprise software applications.",
      features: [
        "Custom Solutions",
    ...
    },
    {
      ...
      fullDesc: "Android and cross-platform application development.",
      features: [
        "iOS Development",
        "Android Development",
        "React Native",
    ...
    },
    {
      ...
      fullDesc: "Modern interfaces focused on user experience and engagement.",
      features: [
        "UI Design",
        "UX Research",
        "Prototyping",
    ...
    },
    {
      ...
      fullDesc: "Secure cloud deployment, hosting and infrastructure services.",
      features: [
        "AWS Services",
        "Cloud Migration",
        "Auto Scaling",
    ...
    },
    {
      ...
      fullDesc: "Online stores with payment, inventory and order systems.",
      features: [
        "Store Setup",
        "Payment Gateway",
    ...
    },
    {
      ...
      fullDesc: "Smart workflows and business process automation solutions.",
      features: [
        "Process Automation",
        "ML Models",
        "Chatbots",
    ...
    },
    {
      ...
      fullDesc: "Continuous updates, monitoring and technical support.",
      features: [
        "24/7 Monitoring",
        "Bug Fixes",
        "Performance Tuning",
    ...
    <div style={{
      ...
      width: "100%"
        ...
        <div className="extended-services">
          ...
          <p className="services-subtitle">Comprehensive solutions tailored to your business needs</p>
        ...
        <div className="why-choose-section">
          ...
          <div className="why-choose-grid" style={{
            ...
            <div className="why-card">
              ...
              <h3>Expert Team</h3>
              <p>Years of industry experience and cutting-edge expertise</p>
            </div>
            <div className="why-card">
              <div className="why-icon">⚡</div>
              <h3>Fast Delivery</h3>
